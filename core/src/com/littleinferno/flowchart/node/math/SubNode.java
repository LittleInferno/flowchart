...
public class SubNode extends Node implements ExpressionGeneratable {
    ...
    public Expression genExpression() {
        ...
        return new BinaryExpression(a.genExpression(), b.genExpression(), BinaryExpression.Operator.sub);
    }
}
